...
public class SpinnerAdapter1 extends BaseAdapter {
    ...
    private List<Spinner1> spinnerList;


    public SpinnerAdapter1(Context context, List<Spinner1> spinnerList) {
    ...
    public int getCount() {
        ...
        return spinnerList !=  null ? spinnerList.size() : 0;
    }
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        ...
        spinner_text.setText(spinnerList.get(i).getName());
        return rootView;
    }
}